...
/**
 * printMagic - print magic numbers of elf header
...
/**
 * printVersion - print version of elf
 * @e_ident: pointer to array
 */
void printVersion(unsigned char *e_ident)
{
...
/**
 * printOsAbi - print the OS/ABI of elf
 * @e_ident: pointer to array
 */
void printOsAbi(unsigned char *e_ident)
{
...
/**
 * printAbi - print ABI version of elf
 * @e_ident: pointer to array
 */
void printAbi(unsigned char *e_ident)
{
...
/**
 * printEntryPoint - prints entry point of elf
 * @e_entry: adress of elf
 * @e_ident: pointer to array
 */
void printEntryPoint(unsigned long int e_entry, unsigned char *e_ident)
{
